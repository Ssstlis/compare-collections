...
| Флаг        | Описание                                          |
|-------------|---------------------------------------------------|
| `--version` | Вывести информацию о сборке (версия, ветка, коммит, время сборки) и выйти |
| `--help`    | Вывести справку по всем флагам и выйти            |

```
bin/compare-collections --version
# compare-collections 0.1.0-SNAPSHOT
#   branch : main
#   commit : abc1234def
#   built  : 2026-02-21T10:15:30.000Z
#   build# : 0
```
